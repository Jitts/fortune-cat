...
Not a cluttered bank dashboard or spreadsheet — dense tables and endless charts are the exact bloat the product exists to escape. Not cold corporate fintech — no navy-and-grey sterility or jargon. Not childish or gimmicky — the cat theme must never tip into toy-like or cartoonish. Not a generic AI SaaS template — no cream background, purple gradients, or tracked-uppercase eyebrows above every section.

## Design Principles

The core verb wins. Logging a transaction is the whole product; it stays the fastest, most obvious thing on screen, never buried under features.

Charm with restraint. The lucky-cat theme earns delight through small, deliberate moments — not by decorating every surface. When charm and credibility conflict, credibility wins.
